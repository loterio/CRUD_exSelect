    ...
    <form method="post">
      <div class="input-group mb-3">
        <div class="input-group-prepend">
          <span class="input-group-text" id="inputGroup-sizing-lg">Média</span>
        </div>
        <input type="text" name='trechoBusca' class="form-control" placeholder='Digite a média pela qual deseja buscar' aria-label="Sizing example input" aria-describedby="inputGroup-sizing-lg" value='<?php echo $grade; ?>'>
      </div> 
    ...
    <tbody>
      <?php
        ...
        try {
          ...
          $consulta = $pdo->query("SELECT * FROM aluno WHERE ROUND(((nota1+nota2+nota3)/3),2) <= '$grade';");         
